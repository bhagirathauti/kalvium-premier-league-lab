...
function filterPlyrByTeamNoOfAwards(team){
  let count = 0;
  let filteredPlayers = [];
  for (let i = 0; i < players.length; i++) {
...
function sortByNameAwardTimes(awardName, noOfTimes, country) {
  var data1 = filterPlyrByAwardTimes(awardName, noOfTimes);
  var data2 = data1.filter(player => player.country == country);
